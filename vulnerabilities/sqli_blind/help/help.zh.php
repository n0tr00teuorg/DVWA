<div class="body_padded">
	...
	<td><div id="code">
		...
		<pre>剧透：<span class="spoiler">?id=1' AND sleep 5&Submit=Submit</span>.</pre>
		...
		<pre>剧透：<span class="spoiler">?id=1 AND sleep 3&Submit=Submit</span>.</pre>
		...
		<pre>剧透：<span class="spoiler">ID: 1' AND sleep 10&Submit=Submit</span>.
			剧透：<span class="spoiler">Should be able to cut out the middle man.</span>.</pre>
	...
	<p>参考：<?php echo dvwaExternalLinkUrlGet( 'https://owasp.org/www-community/attacks/Blind_SQL_Injection' ); ?></p>
</div>
